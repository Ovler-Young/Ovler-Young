...
- [wushuo894/ani-rss](https://github.com/wushuo894/ani-rss) ([v1.2.2](https://github.com/wushuo894/ani-rss/releases/tag/v1.2.2), today) - 自动追番、订阅、下载 蜜柑RSS动漫
- [PBH-BTN/PeerBanHelper](https://github.com/PBH-BTN/PeerBanHelper) ([v7.4.7](https://github.com/PBH-BTN/PeerBanHelper/releases/tag/v7.4.7), 3 days ago) - Automatically block unwanted, leeches and abnormal BT peers with support for customized and cloud rules.| BT 反吸血工具 - 自动封禁不受欢迎、吸血和异常的 BT 客户端，并支持自定义规则。支持 qB/qBEE/Deluge/BiglyBT/BitComet
...
- [fix(workflow): omit errors, build on every commit, and automatically mark as prerelease](https://github.com/CherryHQ/cherry-studio/pull/3206) on [CherryHQ/cherry-studio](https://github.com/CherryHQ/cherry-studio) (4 weeks ago)
