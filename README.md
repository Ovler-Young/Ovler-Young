...
- [Losses/rune](https://github.com/Losses/rune) ([v1.1.0-beta.1](https://github.com/Losses/rune/releases/tag/v1.1.0-beta.1), 5 days ago) - Experience timeless melodies with a music player that blends classic design with modern technology.
- [wushuo894/ani-rss](https://github.com/wushuo894/ani-rss) ([v1.1.215](https://github.com/wushuo894/ani-rss/releases/tag/v1.1.215), 6 days ago) - 自动追番、订阅、下载 蜜柑RSS动漫
...
- [rune: add version 1.0.0](https://github.com/ScoopInstaller/Extras/pull/14636) on [ScoopInstaller/Extras](https://github.com/ScoopInstaller/Extras) (6 days ago)
...
- [nuejs/nue](https://github.com/nuejs/nue) - The Design Engineering Framework for the Web (1 day ago)
- [Qetesh/logi-options-plus-mini](https://github.com/Qetesh/logi-options-plus-mini) - Let logi options plus do the job of keyboard and mouse only!disable logivoice、analytics、flow、sso、update、dfu、aipromptbuilder、device-recommendation (4 days ago)
