...
- [SayaGoodBye/nmbxd-EX](https://github.com/SayaGoodBye/nmbxd-EX) ([v3.3.0](https://github.com/SayaGoodBye/nmbxd-EX/releases/tag/v3.3.0), today) - X岛-EX[nmbxd-EX] 网页端增强，移动端般的浏览体验
- [Ovler-Young/DizzySync](https://github.com/Ovler-Young/DizzySync) ([v2.0.0](https://github.com/Ovler-Young/DizzySync/releases/tag/v2.0.0), 2 days ago) - 
- [icedata-top/hantang-web-backend](https://github.com/icedata-top/hantang-web-backend) ([v2026.06.13-e60cce0](https://github.com/icedata-top/hantang-web-backend/releases/tag/v2026.06.13-e60cce0), 3 days ago) - 冰数据“寒棠”后端，使用Java
- [icedata-top/hantang-dynamic](https://github.com/icedata-top/hantang-dynamic) ([v5.4.0](https://github.com/icedata-top/hantang-dynamic/releases/tag/v5.4.0), 3 days ago) - 
- [z-mio/ParseHub](https://github.com/z-mio/ParseHub) ([v2.0.29](https://github.com/z-mio/ParseHub/releases/tag/v2.0.29), 3 days ago) - 轻量、异步、开箱即用的社交媒体聚合解析库

#### 🔨 My recent Pull Requests

- [fix(app): keep desktop file attachment extensions dotted](https://github.com/getpaseo/paseo/pull/1548) on [getpaseo/paseo](https://github.com/getpaseo/paseo) (1 day ago)
- [Fix release artifact filtering and notes](https://github.com/Ovler-Young/DizzySync/pull/11) on [Ovler-Young/DizzySync](https://github.com/Ovler-Young/DizzySync) (2 days ago)
- [Fix album playback and local state blockers](https://github.com/Ovler-Young/DizzySync/pull/10) on [Ovler-Young/DizzySync](https://github.com/Ovler-Young/DizzySync) (2 days ago)

#### ⭐ Recent Stars

- [Revincx/Yukigram](https://github.com/Revincx/Yukigram) - 64Gram fork (unofficial Telegram Desktop) (3 days ago)
- [nshcr/DockAutoHide](https://github.com/nshcr/DockAutoHide) - A macOS app that auto-hides the Dock only when a window would cover it. (3 days ago)
- [moyogii/maclight-qt](https://github.com/moyogii/maclight-qt) - A fork of the popular GameStream client Moonlight focused only on MacOS. (4 days ago)
