...
- [wushuo894/ani-rss](https://github.com/wushuo894/ani-rss) ([v1.1.221](https://github.com/wushuo894/ani-rss/releases/tag/v1.1.221), 3 days ago) - 自动追番、订阅、下载 蜜柑RSS动漫
- [PBH-BTN/PeerBanHelper](https://github.com/PBH-BTN/PeerBanHelper) ([v7.3.2](https://github.com/PBH-BTN/PeerBanHelper/releases/tag/v7.3.2), 6 days ago) - Automatically block unwanted, leeches and abnormal BT peers with support for customized and cloud rules.| BT 反吸血工具 - 自动封禁不受欢迎、吸血和异常的 BT 客户端，并支持自定义规则。支持 qB/qBEE/Deluge/BiglyBT/Azureus/Vuze/BitComet
...
- [ci: 更新 pre-commit hook以加快pre-commit速度](https://github.com/PBH-BTN/PeerBanHelper/pull/915) on [PBH-BTN/PeerBanHelper](https://github.com/PBH-BTN/PeerBanHelper) (3 days ago)
- [ci: 更新 pre-commit hook以加快pre-commit速度](https://github.com/Ovler-Young/PeerBanHelper/pull/1) on [Ovler-Young/PeerBanHelper](https://github.com/Ovler-Young/PeerBanHelper) (3 days ago)
...
- [yuyuyzl/EasyVtuber](https://github.com/yuyuyzl/EasyVtuber) - Based on Talking-head-anime 3, works like Vtube Studio. (3 days ago)
