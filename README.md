...
- [wushuo894/ani-rss](https://github.com/wushuo894/ani-rss) ([v1.1.345](https://github.com/wushuo894/ani-rss/releases/tag/v1.1.345), today) - 自动追番、订阅、下载 蜜柑RSS动漫
...
- [Fix wrong domain headers, and better log control](https://github.com/Ovler-Young/nmbXdBackup-gui/pull/17) on [Ovler-Young/nmbXdBackup-gui](https://github.com/Ovler-Young/nmbXdBackup-gui) (2 days ago)
