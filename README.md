...
- [Losses/rune](https://github.com/Losses/rune) ([v1.1.0-alpha.5](https://github.com/Losses/rune/releases/tag/v1.1.0-alpha.5), 1 day ago) - Experience timeless melodies with a music player that blends classic design with modern technology.
- [wushuo894/ani-rss](https://github.com/wushuo894/ani-rss) ([v1.1.214](https://github.com/wushuo894/ani-rss/releases/tag/v1.1.214), 3 days ago) - 自动追番、订阅、下载 蜜柑RSS动漫
...
- [fix: Update makeLatest condition to exclude alpha and beta branches](https://github.com/Losses/rune/pull/209) on [Losses/rune](https://github.com/Losses/rune) (today)
