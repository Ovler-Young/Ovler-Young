...
- [wushuo894/ani-rss](https://github.com/wushuo894/ani-rss) ([v1.1.320](https://github.com/wushuo894/ani-rss/releases/tag/v1.1.320), 2 days ago) - 自动追番、订阅、下载 蜜柑RSS动漫
- [Losses/rune](https://github.com/Losses/rune) ([v2.0.0-alpha.3](https://github.com/Losses/rune/releases/tag/v2.0.0-alpha.3), 4 days ago) - Experience timeless melodies with a music player that blends classic design with modern technology.
...
- [fix(workflow): omit errors, build on every commit, and automatically mark as prerelease](https://github.com/CherryHQ/cherry-studio/pull/3206) on [CherryHQ/cherry-studio](https://github.com/CherryHQ/cherry-studio) (4 days ago)
